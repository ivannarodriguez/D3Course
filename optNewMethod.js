...
let circledata = [{ x: 0, y: 300, r: 15, group: 'endpoint', html: 'test1'}, //-90
                ...
                { x: 1200, y: 600, r: 15, group: 'endpoint', html: ''},
                { x: 900, y: 800, r: 15, group: 'stem', html: 'stem ext test'}, //stemstartapplying
                { x: 1200, y: 800, r: 15, group: 'stem', html: 'stem ext test'}] //opt 60
...
let linedata = [{x1: circledata[0].x, x2: circledata[2].x, y1:circledata[0].y, y2:circledata[0].y, group: 'blackline'},
                ...
                {x1: 900, x2: 2500, y1:800, y2:800, group: 'stem' }]
...
let yScale = d3.scaleLinear()
  ...
  .range([10, 200]); //backwards because 0,0 is at top left corner
